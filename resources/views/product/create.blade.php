                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="my-4 wow animated fadeInDown">
                                        ...
                                        <input type="text" name="sku" class="form-control p-3 rounded-pill shadow-none" placeholder="Example: 13245"   />
                                        @error('sku')
                                ...
                                <div class="col-lg-6">
                                    <div class="my-4 wow animated fadeInDown">
                                        ...
                                        <input type="text" name="name" class="form-control p-3 rounded-pill shadow-none" placeholder="Example: Weight Loss Belt"   />
                                        @error('name')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="my-4 wow animated fadeInDown">
                                        ...
                                        <input type="text" name="manufacturer" class="form-control p-3 rounded-pill shadow-none" placeholder="Example: Medikit One"   />
                                        @error('manufacturer')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="my-4 wow animated fadeInDown">
                                        ...
                                        <input type="text" class="form-control p-3 rounded-pill shadow-none" placeholder="Example: USA" name="country" />
                                        @error('country')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="my-4 wow animated fadeInDown">
                                        ...
                                        <input type="text"  name="model_no" class="form-control p-3 rounded-pill shadow-none" placeholder="Example: 465879"  />
                                        @error('model_no')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="my-4 wow animated fadeInDown">
                                        ...
                                        <input type="text"  name="mdma_no" class="form-control p-3 rounded-pill shadow-none" placeholder="Example: MDMA-879654"  />
                                        @error('mdma_no')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="mt-2 wow animated fadeInDown align-items-center d-flex gap-3">
                                        <div class="form-check">
                                            <input class="form-check-input mt-0 border" type="radio" name="classification" id="c1" value="Class I" checked />
                                            <label class="form-check-label" for="c1">Class I</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input mt-0 border" type="radio" name="classification" id="c2" value="Class II" />
                                            <label class="form-check-label" for="c2">Class II</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input mt-0 border" type="radio" name="classification" id="c3" value="Class III" />
                                            <label class="form-check-label" for="c3">Class III</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input mt-0 border" type="radio" name="classification" id="c4" value="Class IV" />
                                            <label class="form-check-label" for="c4">Class IV</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input mt-0 border" type="radio" name="classification" id="c5" value="Class V"/>
                                            <label class="form-check-label" for="c5">Class V</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input mt-0 border" type="radio" name="classification" id="c6" value="Class VI" />
                                            <label class="form-check-label" for="c6">Class VI</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-l2">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="my-4 wow animated fadeInDown">
                                                    ...
                                                    <input type="text" class="form-control p-3 rounded-pill shadow-none" placeholder="Example: 55" name="width" />
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="my-4 wow animated fadeInDown">
                                                    <label class="form-label">Length</label>
                                                    <input type="text" class="form-control p-3 rounded-pill shadow-none" placeholder="Example: 88" name="length" />
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="my-4 wow animated fadeInDown">
                                                    <label class="form-label">Height</label>
                                                    <input type="text" class="form-control p-3 rounded-pill shadow-none" placeholder="Example: 15" name="height" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="my-4 wow animated fadeInDown">
                                        ...
                                        <input type="text" class="form-control p-3 rounded-pill shadow-none" placeholder="Example: Xoft Med Corp" name="price"/>
                                        @error('price')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="my-4 wow animated fadeInDown">
                                        ...
                                        <input type="text" class="form-control p-3 rounded-pill shadow-none" placeholder="Example: Xoft Med Corp" name="discount_price"/>
                                    </div>
                                </div>
